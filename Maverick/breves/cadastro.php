...
<body>
    <div class="container">
        ...
        <!--Botao de inclusao-->
        <a href="inserir.php" class="btn btn-success mb-3">Novo Registro de Breve</a>
        <!--Tabela de dados-->
        <table>
            <theader>
                <tr>
            ...
            <?php foreach($exibirBreve as $breve): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="atualizar.php?id=<?php echo $breve['idBreve']; ?>" class="btn btn-warning btn-sm">Editar</a>
